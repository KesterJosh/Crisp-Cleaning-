...
var SpriteAnimator = /** @class */ (function (_super) {
    ...
    SpriteAnimator.prototype.render = function () {
        ...
        return (React.createElement("div", { className: styles.wrapper, style: { width: width, height: height } },
            React.createElement("div", { className: styles.innerWrapper, style: { top: -top, left: -left } }, React.Children.only(children))));
    };
