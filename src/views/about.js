...
const About = (props) => {
  ...
  useEffect(() => {
    ...
    gsap.fromTo(".home1-image01y", {transform: `translate3d( -100, 0, 0)`},{
    ...
    <div className="home1-container">
      ...
      <div className="home-container010">
        <div className='MenuBug'>
          ...
          {/* {Summary}/ {tabs}/{type} / {(sum)?"On":"Off"} */}
            ...
            <Link to="/" className="home-container013" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
          ...
          <div className="home-container017">
            <div className="home-container013"  onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
      ...
      <Mobilex mobileM={mobileMenu}/>
        ...
        <div className='Mobilegeneral'>
          ...
          <Link to="/about"><h2 className="appointed">About</h2></Link>
          ...
          <div className="home1-container04">
            <div className="home1-container05">
              <Link to="/about" className="home1-navlink button" onMouseEnter={activateX} onMouseLeave={offX}>
                About us
              </Link>
        ...
        <div className="home1-container16">
          <div className="home1-container17">
            <div className="home1-container18">
              <div  className="home1-image01" style={{borderRadius:'30px'}}>
              <img
                alt="image"
                src={require("./img/vector300w.png")}
                className="home1-image01y"
                style={{transform: `translate3d( ${sliderIn-100}px, 0, 0)`}}
              /></div>
              <h1 className="home1-heading1">
            ...
            <span className="home1-text40">
              <span>
                We provide a dynamic and seamless cleaning experience that not
                only ensures cleanliness but also contributes to 
              </span>
              <span>
                sealing deals, attracting top talent, fostering connections, and
                accelerating business growth.
              </span>
            </span>
          </div>
          <div className="home1-container19">
            <div className="home1-container20"></div>
            <div className="home1-container21"></div>
            <div className="home1-container22"></div>
          </div>
          <div className="home1-container23">
            <div className="home1-container24">
              <div className="home1-container25"></div>
              <div className="home1-container26"></div>
              <div className="home1-container27"></div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="home1-container29">
          <div className="home1-container30">
            ...
            <h1 className="home1-text43">
              ...
              <br></br>
              <span className="home1-text48"><span> </span> in Pristine Living and
                <span
                  dangerouslySetInnerHTML={{
                    __html: ' ',
                  }}
            ...
            <h1 className="home1-text43x">
              <span className="home1-text44">Beyond Cleaning,</span>
              <span className="home1-text46">Becoming 
              <br className="home1-text45"></br>Your Partner</span>
          ...
          <img alt="image" src={require("./img/cln2-1400w.png")} className="home1-image03" />
        </div>
      </div>
      <div className="home1-container31">
        <div className="home1-container32">
          <div className="home1-container33 skewed">
              ...
              <div className='home1-image04x'
              style={{width:'-100px'}}
              ref={sliderRef} 
      onMouseMove={handleMouseMove} 
              >
                <ImgComparisonSlider value={position}>
                  <img slot="first" src="https://aheioqhobo.cloudimg.io/v7/_playground-bucket-v2.teleporthq.io_/d5fa5283-60b3-4996-9cc5-66cb59380128/b1cc48df-f5ef-4fc3-a5a3-ce816243119c?org_if_sml=1&force_format=original" className='containX'/>
                  <img slot="second" src="https://aheioqhobo.cloudimg.io/v7/_playground-bucket-v2.teleporthq.io_/d5fa5283-60b3-4996-9cc5-66cb59380128/31e8de97-f516-4eb6-b1fb-9d035b308d13?org_if_sml=1&force_format=original" className='containX'/>
                </ImgComparisonSlider>
              </div>
      ...
      <div className="home1-container35">
          ...
          <div className="home1-header">
            <div className="home1-container37">
              ...
              <img
                ...
                style={{transform: `translate3d( ${sliderInx-100}px, 0, 0)`}}
              />
              </div>
        ...
        <div className="home1-container38">
          <div className="home1-container39">
            <div className='teamView' onMouseOver={overlayA1} onMouseLeave={overlayB1}>
              <div className='overlay'>
                <h1 className='nameC1'>Jonny Rein</h1>
                <h3 className={(Cleaner)?'typeC1On':'typeC1'} onMouseOver={()=>{setCleaner(true)}} onMouseLeave={()=>{setCleaner(false)}} style={{cursor:'pointer'}}>Cleaner</h3>
                <div className='socials'>
                  <div style={{width:'60px', height:'60px', marginLeft:'10px', marginRight:'10px',cursor:'pointer', background:back1, borderRadius:'100%', display:'flex', justifyContent:'center', alignItems:'center'}}
                  onMouseOver={()=>{setback1('black'); setcol1('white');}} onMouseLeave={()=>{setback1('white'); setcol1('black');}}>
                    <p style={{fontWeight:'bolder', fontSize:'18px', color:col1}}>f</p>
                  </div>
                  <div style={{width:'60px', height:'60px', marginLeft:'10px', marginRight:'10px',cursor:'pointer', background:back2, borderRadius:'100%', display:'flex', justifyContent:'center', alignItems:'center'}}
                  onMouseOver={()=>{setback2('black'); setcol2('white');}} onMouseLeave={()=>{setback2('white'); setcol2('black');}}>
                    {(back2=="white")?<img  src={require("./img/twitter_Black.png")} style={{width:'25%'}}/>:<img  src={require("./img/twitter_white.png")} style={{width:'25%'}}/>}
                  </div>
                  <div style={{width:'60px', height:'60px', background:back3, borderRadius:'100%', display:'flex',cursor:'pointer', justifyContent:'center', alignItems:'center'}}
                  onMouseOver={()=>{setback3('black'); setcol3('white');}} onMouseLeave={()=>{setback3('white'); setcol3('black');}}>
                    <p style={{fontWeight:'bolder', fontSize:'18px', color:col3}}>in</p>
                  </div>
                </div>
              </div>
            </div>
            <div className='teamView2' onMouseOver={overlayA2} onMouseLeave={overlayB2}>
            ...
            <div className='teamView3' onMouseOver={overlayA3} onMouseLeave={overlayB3}>
            ...
            {/* <img alt="image" src={require("./img/teamW.png")} className="home1-image07" />
            <img alt="image" src={require("./img/teamW.png")} className="home1-image08" /> */}
          </div>
          <div className="home1-container40">
          <div className='teamView4' onMouseOver={overlayA4} onMouseLeave={overlayB4}>
          ...
          <div className='teamView5' onMouseOver={overlayA5} onMouseLeave={overlayB5}>
        ...
        <div className="home1-container49">
          <div className="home1-container50">
            ...
            <div className="home1-container51">
              <button type="button" className="home1-button button" onMouseEnter={activateX} onMouseLeave={offX} style={{cursor:'pointer'}}>
                Take Action
              </button>
              <button type="button" className="home1-button1 button" onMouseEnter={activateX} onMouseLeave={offX} style={{cursor:'pointer'}}>
                Have a Question?
              </button>
            </div>
          </div>
